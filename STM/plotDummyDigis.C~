...
void plotDummyDigis(std::string filename = "stmWaveformDigis.root") {
  ...
  c1->cd(1);
  TH1F* hRawWaveform = (TH1F*) file->Get("plotRawWaveformDigisHPGe/evt0_waveform0");
  ...
  c1->cd(2);
  TH1F* hZSWaveform = (TH1F*) file->Get("plotZSWaveformDigisHPGe/evt0_waveform0");
  ...
  c1->cd(3);
  TH1F* hPHWaveform = (TH1F*) file->Get("plotPHWaveformDigisHPGe/evt0_waveform0");
